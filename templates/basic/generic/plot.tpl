...
<tr><td width="33%" align="left">{$data[rowl].node_name|escape} (#{$data[rowl].node_id})</td><td width="33%" align="center">-- {$data[rowl].distance|round:3}km --</td><td align="right"><a href="{$extra_data.EDIT[rowl]}">{$data[rowl].peer_node_name|escape} (#{$data[rowl].links__peer_node_id})</a></td></tr>
