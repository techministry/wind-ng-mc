						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table-search-menu">
							<tr>
								...
								<td style="font-size: 12px;">
									...
									{% include "generic/qs.tpl" qs=query_string %}
...
<br>{{ $stats_nodes_active }}/{{ $stats_nodes_total }} <span style="color: black;">{$lang.active_nodes|lower}</span></td>
   ...
   <tr>
		<td class="search-menu">
			...
			{% if $smarty_section_row_index is not even %}
	...
	<tr>
		<td class="search-menu">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-mynodes">
				...
				<tr>
					<td colspan="2" class="menu-small-links">{% include "generic/link.tpl" content="$ranges_waiting `$lang.waiting`" link=link_ranges_waiting %} {% include "generic/link.tpl" content="$ranges_req_del `$lang.for_deletion`" link=link_ranges_req_del %}</td>
				</tr>
				{% endif %}
				{% if $$link_dnszones != '' %}
				<tr class="table-form-row1">
				...
				<tr>
					<td colspan="2" class="menu-small-links">{% include "generic/link.tpl" content="$dnszones_waiting `$lang.waiting`" link=link_dnszones_waiting %} {% include "generic/link.tpl" content="$dnszones_req_del `$lang.for_deletion`" link=link_dnszones_req_del %}</td>
				</tr>
				{% endif %}
				...
				<tr>
					<td colspan="2" class="menu-small-links">{% include "generic/link.tpl" content="$dnsnameservers_waiting `$lang.waiting`" link=link_dnsnameservers_waiting %} {% include "generic/link.tpl" content="$dnsnameservers_req_del `$lang.for_deletion`" link=link_dnsnameservers_req_del %}</td>
				</tr>
				{% endif %}
				<tr>
					<td colspan="2" class="table-middle-left-pad"></td>
