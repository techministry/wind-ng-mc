...
$lang = array(
	...
	'message' => array(
		'info' => array(
			...
			'site_settings_saved' => array(
				...
				'body' => "Οι ρυθμίσεις αποθηκεύτηκαν με επιτυχία."
			),
			'login_success' => array(
		...
		'error' => array(
			'site_settings_save_failed' => array(
				'title' => "Ρυθμίσεις Ιστοσελίδας",
				'body' => "Αποτυχία αποθήκευσης ρυθμίσεων. Ελέγξτε τα δικαιώματα αρχείων."
			),
	...
	'admin_site_settings' => 'Ρυθμίσεις Ιστοσελίδας',
	'admin_startup_page_content' => 'Περιεχόμενο Αρχικής Σελίδας',
	'admin_startup_page_help' => 'Επεξεργαστείτε το περιεχόμενο που εμφανίζεται στην αρχική σελίδα. Χρησιμοποιήστε τον επεξεργαστή κειμένου παρακάτω.',
	'save' => 'Αποθήκευση',
	'theme' => 'Θέμα',
	'theme_selection' => 'Επιλογή Θέματος',
	'theme_selection_help' => 'Επιλέξτε το οπτικό θέμα για την ιστοσελίδα. Οι αλλαγές θα εφαρμοστούν σε όλους τους χρήστες.',
	'theme_light' => 'Φωτεινό',
	'theme_dark' => 'Σκοτεινό',
	'theme_preview_mode' => 'Προεπισκόπηση - αποθηκεύστε για εφαρμογή',
	'admin_actionlog' => 'Αρχείο Ενεργειών',
	'admin_services' => 'Υπηρεσίες',
	'dnstld' => 'DNS TLD',
	'date_in' => 'Ημερομηνία',
	'ip' => 'Διεύθυνση IP',
	'name_ns' => 'Όνομα DNS Κόμβου',
	'node_name' => 'Όνομα Κόμβου',
	'node_id' => 'ID Κόμβου',
	'c_node_id' => 'ID Συνδεδεμένου Κόμβου',
	'c_node_name' => 'Συνδεδεμένος Κόμβος',
	'c_status' => 'Κατάσταση Σύνδεσης',
	'links__ip' => 'Διεύθυνση IP',
	'Link type' => 'Τύπος Σύνδεσης',
	'Info' => 'Πληροφορίες',
	'SSID' => 'SSID',
	'Protocol' => 'Πρωτόκολλο',
